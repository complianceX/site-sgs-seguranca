        ...
        <div className="max-w-4xl mb-24">
          <FadeIn direction="right">
            ...
            <p className="text-xl md:text-2xl text-slate-500 leading-relaxed font-medium text-pretty max-w-3xl">
              Baixe templates, guias e checklists profissionais validados por especialistas em SST. 
              Prontos para uso imediato na sua operação.
            </p>
          </FadeIn>
        </div>
              ...
              >
                ...
                {!submitted ? (
                  <div className="relative z-10">
                    ...
                    <h2 className="text-3xl font-black text-sgs-navy mb-6 tracking-tight">Onde enviamos seu material?</h2>
                    <p className="text-slate-500 font-medium mb-10 leading-relaxed">
                      Informe seu e-mail corporativo para receber o link de download instantaneamente e nossas atualizações de SST.
                    </p>
                    ...
                    <form onSubmit={handleDownload} className="space-y-6">
                      ...
                      <button className="w-full bg-primary text-white font-black py-5 rounded-2xl shadow-xl shadow-primary/20 hover:bg-primary/90 transition-all flex items-center justify-center gap-3 text-lg group/btn">
                  ...
                  <div className="relative z-10 text-center py-10">
                    ...
                    <h2 className="text-3xl font-black text-sgs-navy mb-4 tracking-tight">E-mail enviado!</h2>
                    <p className="text-slate-500 font-medium mb-8 leading-relaxed">
                      Verifique sua caixa de entrada em instantes. O link de download já está a caminho.
                    </p>
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center relative z-10">
              <div>
                ...
                <div className="space-y-8">
                  {[
                    { title: "Validação Técnica", desc: "Todo material é revisado por engenheiros e técnicos de segurança." },
                    { title: "Conformidade Total", desc: "Templates estruturados rigorosamente conforme as NRs vigentes." },
