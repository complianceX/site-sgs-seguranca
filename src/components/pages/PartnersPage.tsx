...
const tiers = [
  {
    icon: Handshake,
    name: "Consultoria",
    description: "Parceiros de consultoria em SST que implementam o SGS em seus clientes.",
    benefits: ["Comissionamento por cliente indicado", "Suporte técnico dedicado", "Materiais de vendas exclusivos", "Treinamento certificado"],
  },
  {
    icon: Cpu,
    name: "Tecnologia",
    description: "Integradores e ISVs que conectam o SGS a outras plataformas do ecossistema corporativo.",
    benefits: ["API e webhooks prioritários", "Ambiente sandbox exclusivo", "Roadmap compartilhado", "Co-marketing técnico"],
  },
  {
    icon: Globe,
    name: "Distribuição",
    description: "Revendas e distribuidores que comercializam o SGS como parte de seu portfólio de SST.",
    benefits: ["Margens diferenciadas", "Lead sharing program", "Portal do parceiro", "Eventos e workshops exclusivos"],
  },
];
      ...
      <div className="container">
        <FadeIn>
          <header className="mx-auto mb-20 max-w-4xl text-center">
            ...
            <h1 className="mb-8 text-5xl font-black tracking-tight text-sgs-navy text-balance md:text-7xl">
              <MotionText delay={0.1}>Parceiros e Canais</MotionText>
            </h1>
            <p className="text-xl font-medium leading-relaxed text-slate-500 text-pretty">
              O SGS é construído em parceria com os melhores profissionais e empresas do mercado de SST. 
              Junte-se a um ecossistema que transforma a gestão de segurança do trabalho no Brasil.
            </p>
          </header>
        </FadeIn>
          ...
          {tiers.map((tier, index) => (
            <FadeIn key={tier.name} delay={0.1 * (index + 1)}>
              <MotionCard className="flex flex-col">
                <tier.icon className="mb-6 h-10 w-10 text-primary" aria-hidden="true" />
                ...
                <ul className="mb-8 space-y-3">
                  {tier.benefits.map((benefit) => (
                    <li key={benefit} className="flex items-start gap-3">
                      ...
                      <span className="text-sm font-semibold text-sgs-navy">{benefit}</span>
                    </li>
                  ))}
                </ul>
              </MotionCard>
        ...
        <FadeIn delay={0.3}>
          <section className="mb-32 rounded-[3rem] bg-slate-50 p-12 lg:p-20">
            <h2 className="mb-12 text-center text-3xl font-black text-sgs-navy lg:text-5xl">
        ...
        <FadeIn>
          <section className="rounded-[3rem] bg-primary p-12 text-center text-white lg:p-20">
            ...
            <p className="mx-auto mb-10 max-w-2xl text-lg text-white/80">
              Entre em contato com nossa equipe de canais e descubra o melhor modelo de parceria para seu negócio.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <TrackedLink
                href={schedulingHref}
                trackLabel="Ser parceiro - Parceiros"
