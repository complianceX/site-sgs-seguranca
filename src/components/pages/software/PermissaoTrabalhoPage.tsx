...
import { permissaoTrabalhoData } from "@/components/features/software/data/permissao-trabalho";

export function PermissaoTrabalhoPage() {
  const d = permissaoTrabalhoData;
