...
import { checklistsDigitaisData } from "@/components/features/software/data/checklists-digitais";

export function ChecklistsDigitaisPage() {
  const d = checklistsDigitaisData;
