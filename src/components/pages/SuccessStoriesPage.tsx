...
import { ArrowRight, Clock, FileCheck, TrendingUp, CheckCircle2, HardHat, Factory, Truck } from "lucide-react";
...
const caseStudies = [
  {
    ...
    solution: "Implantaçao do módulo de APR Digital integrado ao DDS e PT, com evidências fotográficas por obra.",
    results: [
      "70% redução no tempo de preparação para auditorias",
      "100% digitalização das APRs emitidas",
      "95% de adesão da equipe de campo em 60 dias",
    ],
  },
  {
    icon: Factory,
    ...
    results: [
      "100% de adoção digital do DDS em 3 turnos",
      "60% redução de horas administrativas com SST",
      "Zero não conformidades em auditoria ISO 45001",
    ],
  },
  {
    icon: Truck,
    ...
    results: [
      "Centralização de 12 unidades em uma única plataforma",
      "80% redução em retrabalho documental",
      "Relatórios gerenciais em tempo real para diretoria",
    ],
  },
];
        ...
        <FadeIn>
          <header className="mx-auto mb-20 max-w-4xl text-center">
            ...
            <p className="text-xl font-medium leading-relaxed text-slate-500 text-pretty">
              Resultados reais de empresas que transformaram a gestão de SST com o SGS. 
              Cada caso representa um passo rumo à excelência operacional.
            </p>
          </header>
        </FadeIn>
              ...
              <MotionCard>
                <div className="grid gap-10 lg:grid-cols-5">
                  ...
                  <div className="lg:col-span-3">
                    ...
                    <div className="mb-6">
                      <h3 className="mb-2 flex items-center gap-2 text-sm font-black uppercase tracking-tight text-slate-400">
                        Desafio
                      </h3>
        ...
        <FadeIn>
          <section className="rounded-[3rem] bg-primary p-12 text-center text-white lg:p-20">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <TrackedLink
                href={schedulingHref}
                trackLabel="Agendar demonstração - Casos de Sucesso"
